...
= 1.0.18 =
* Fix: Solusi Total Fatal Error WAH_Router::register_query_vars (Menambahkan alias fungsi register_query_vars pada WAH_Router untuk menyelesaikan masalah callback TypeError).
